...
pres_2022_R2_circonscriptions <- read_excel("./data-raw/2022/resultats-par-niveau-cirlg-t2-france-entiere.xlsx", 
                                            guess_max = 600, sheet = 1) %>%
  mutate(Inscrits = as.numeric(Inscrits))

pres_2022_R2_circonscriptions_cleaned <- lire(pres_2022_R2_circonscriptions, 
...
pres_2022_R2_circonscriptions_cleaned <- pres_2022_R2_circonscriptions_cleaned %>% 
...
readr::write_excel_csv(pres_2022_R2_circonscriptions_cleaned, path = "./data/P2022_Resultats_Circonscriptions_T2.csv")
rio::export(pres_2022_R2_circonscriptions_cleaned, file = "./data/P2022_Resultats_Circonscriptions_T2.xlsx")
